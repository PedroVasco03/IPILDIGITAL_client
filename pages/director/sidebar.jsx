        ...
        <>
            <nav className={styleSide.side+" "+styleGeral.side}>
                <ul className={styleSide.ul}>
                    <li className={styleSide.li}><a href={"/director/inicio"} className={styleSide.a} style={{
                                    fontWeight: currentRoute === "/director/inicio" ? 700 :" ",
                                    background: currentRoute === "/director/inicio" ? "#1478b1" : "",
                                }} > 
                        <Image className={styleSide.i} src={init} alt='inicio'/>
                        <span className={styleSide.side_item+" "+styleSide.span}>Início</span>
                    </a></li>
                    <li className={styleSide.li}><a href={"/director/chat"} className={styleSide.a} style={{
                                    fontWeight: currentRoute === "/director/chat" ? 700 :" ",
                                    background: currentRoute === "/director/chat" ? "#1478b1" : "",
                                }} >
                        <Image className={styleSide.i} src={chat} alt='Chat'/>
                        <span className={styleSide.side_item+" "+styleSide.span}>Chat</span>
                    </a></li>
                    <li className={styleSide.li}><a href={"/director/team"} className={styleSide.a} style={{
                                    fontWeight: currentRoute === "/director/team" ? 700 :" ",
                                    background: currentRoute === "/director/team" ? "#1478b1" : "",
                                }} >
                        <Image className={styleSide.i} src={coord} alt='Coordenação'/>
                        <span className={styleSide.side_item+" "+styleSide.span}>Secretária</span>
                    </a></li>
                    <li className={styleSide.li}><a href={"/director/definicoes"} className={styleSide.a} style={{
                                    fontWeight: currentRoute === "/director/definicoes" ? 700 :" ",
                                    background: currentRoute === "/director/definicoes" ? "#1478b1" : "",
                                }} >
