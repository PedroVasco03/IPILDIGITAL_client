        ...
        <div className='container-fluid p-2' id='what'>
            <div className={style2.container_sobre+' w-100'}>
                ...
                <Fade left cascade >
                    ...
                    <Fade top >
                        <h2  className={style.title + " mb-5"}>O que é o IPILDIGITAL?</h2>
                    </Fade>
                        <p>
                            IPILDIGITAL é um sistema que permite melhorar o funcionamento da escola tornando os trabalhos totalmente digitais. 
                        </p>
                        <p className='m-0'> Porquê o nome <b>IPIL DIGITAL</b> ?  Este nome indica que o nosso sistema é voltado inicialmente ao nosso instituto, procurado tornar os serviços oferecidos pelo mesmo mais digitais possíveis.</p>
                    </div>
                </Fade>
                <Fade bottom>
