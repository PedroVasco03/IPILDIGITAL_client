...
const tCoordenador = () => {
  ...
  const getCoordenador = async () => {
    await axios.get("http://localhost:5000/coordenador").then((response) => {
                    ...
                    <table>
                      <thead>
                        <tr className="row100 head">
                          ...
                          <th className="cell100 column4 text-white">
                            ÁREA DE FORMAÇÃO
                          </th>
                        ...
                        {coordenador.map((data) => {
                          return (
                            <tr key={data.id} className="row100 body">
                              ...
                              <td className="cell100 column4 dois">{data.area}</td>
