    ...
    return(
        ...
        <nav className={styleSide.side+" "+styleGeral.side}>
                <ul className={styleSide.ul}>
                    <li className={styleSide.li}><a href={"/encarregado/inicio"} className={styleSide.a} style={{
                                    fontWeight: currentRoute === "/encarregado/inicio" ? 700 :" ",
                                    background: currentRoute === "/encarregado/inicio" ? "#1478b1" : "",
                                }} > 
                        <Image className={styleSide.i} src={init} alt='inicio'/>
                        <span className={styleSide.side_item+" "+styleSide.span}>Início</span>
                    </a></li>
                    <li className={styleSide.li}><a href={"/encarregado/chat"} className={styleSide.a} style={{
                                    fontWeight: currentRoute === "/encarregado/chat" ? 700 :" ",
                                    background: currentRoute === "/encarregado/chat" ? "#1478b1" : "",
                                }} >
                        <Image className={styleSide.i} src={chat} alt='Chat'/>
                        <span className={styleSide.side_item+" "+styleSide.span}>Chat</span>
                    </a></li>
                    
                    <li className={styleSide.li}><a href={"/encarregado/definicoes"} className={styleSide.a} style={{
                                    fontWeight: currentRoute === "/encarregado/definicoes" ? 700 :" ",
                                    background: currentRoute === "/encarregado/definicoes" ? "#1478b1" : "",
                                }} >
                    ...
                    <li onClick={()=>{
                        ...
                        }} className={styleSide.li}><a href="/login/encarregado/login" className={styleSide.a+" "+styleSide.logout}>
